...
error_t DestroyList(List* list) // TODO: fill with poison value 
    {
    AssertSoft(list, NULL_PTR);
...
error_t InsertAfter(List* list, size_t index, Elem_t value)
    {
...
error_t InsertBefore(List* list, size_t index, Elem_t value)
    {
    return InsertAfter(list, PREV(index), value);
    }

error_t PushFront(List* list, Elem_t value)
    {
    return InsertAfter(list, list->head, value);
    }

error_t PushBack(List* list, Elem_t value) // TODO: return physical address
    {
...
error_t linearizeList(List* list)
    {
